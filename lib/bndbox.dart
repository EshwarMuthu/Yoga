...
FlutterTts flutterTts = new FlutterTts();
  BndBox({Key key, this.results, this.previewH, this.previewW, this.screenH, this.screenW, this.customModel}) : super(key: key);
  @override
  BndBoxState createState()=>new BndBoxState();
}
class BndBoxState extends State<BndBox> {
  ...
  Future _speak() async{
    var result = await widget.flutterTts.speak("You have completed your yoga task today");
